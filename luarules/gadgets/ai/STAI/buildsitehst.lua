...
-- function BuildSiteHST:searchPosNearThingOriginal(utype,builder,thing,range,spaceEquals,minDist,cat)
...
-- 					self:EchoDebug('no same unit near: pass',builder,tgPos,minDist,range,self.ai.armyhst.unitTable[builderName].losRadius)
-- 					p = self:ClosestBuildSpot(builder, tgPos, utype , minDist, nil, nil, range or self.ai.armyhst.unitTable[builderName].losRadius)
-- 					self:EchoDebug('p = ',p)
-- 				else
-- 					self:EchoDebug('same unit near: skip')
-- 				end
