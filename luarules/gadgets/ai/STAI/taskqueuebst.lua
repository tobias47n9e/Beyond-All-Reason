...
function TaskQueueBST:CategoryEconFilter(cat,param,name)
	...
	elseif cat == '_plasma_' then
		check =  E.income > 5000 and M.income > 120 and E.full > 0.5 and M.full > 0.5
	elseif cat == '_lol_' then
		check =  E.income > 15000 and M.income > 200 and E.full > 0.5 and M.full > 0.5
	...
	elseif cat == '_silo_' then
		check =  E.income > 10000 and M.income > 100 and E.full > 0.5 and M.full > 0.5
	elseif cat == '_antinuke_' then
		check =  E.income > 4000 and M.income > 75 and E.full > 0.5 and M.full > 0.3
